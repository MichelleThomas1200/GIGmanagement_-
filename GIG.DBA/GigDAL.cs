...
namespace GIG.DAL
{
    public class GigDAL
    {
        ...
        {
            //LAPTOP-4801LI3A
            con = new SqlConnection(@"data source=LAPTOP-4801LI3A; database=gmsDB; Integrated Security=true");
        ...
        public bool AddGig1(Gig gigObj) //works
        {
            ...
            try
            {
                if(gigObj!=null)
                {
                    ...
                    param[1] = new SqlParameter("@dateTime", gigObj.TIMING);
        ...
        public Gig SearchGigByID(int gigId)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    tempGig.TIMING = DateTime.Parse(drow[1].ToString());
